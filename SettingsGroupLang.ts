...
export class NetworkSelectModalLang {
...
export class AddWalletScreenLang {
  static ok: SystemLang = {
    jp: "OK",
    en: "OK",
    es: "OK",
...
export class DesignWalletTabModalLang {
  static ok: SystemLang = {
    jp: "OK",
    en: "OK",
    es: "OK",
...
export class NftThemeModalLang {
  static ok: SystemLang = {
    jp: "OK",
    en: "OK",
    es: "OK",
...
export class MosaicTagEditorLang {
  static ok: SystemLang = {
    jp: "OK",
    en: "OK",
    es: "OK",
...
export class WalletTabSizeCalcModalLang {
  static pair: SystemLang = {
    jp: "XYM/JPY",
    en: "XYM/USD",
    es: "XYM/USD",
